...
// connection pool to the SQLite database at path.
...
// Migrate brings the schema up to date by running every pending, embedded
// Goose migration. It never requires the goose CLI at runtime.
